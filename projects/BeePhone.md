...
<div style="display: flex; align-items: center;">
  <div>
    ...
    <div style="margin-left: 20px; display: flex;">
        <img width="200px" style="margin: 10px;" src="../img/BeePhone/BeeMe.jpeg" alt="Coqui Frog">
        <img width="200px" style="margin: 10px;" src="../img/BeePhone/BeeHive.jpeg" alt="Coqui Frog">
      </div>
</div>
...
<div style="display: flex; align-items: center;">
  <div style="margin-right: 20px; display: flex;">
    <img width="200px" style="margin: 10px;" src="../img/BeePhone/BeePhone.jpeg" alt="Coqui Frog">
    <img width="200px" style="margin: 10px;" src="../img/BeePhone/BeeSolar.jpeg" alt="Coqui Frog">
  </div>
  <div>
